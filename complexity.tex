...
\para{Terminology}
We use the triple exponential function $\exptriple(k) = 2^{2^{2^k}}$.
...
\lukasz{Should we add citation?}
\sla{maybe not}
\mei{I think it would be good to reinforce "yes, this particular paper
is where you should look for this property of Parikh's theorem".}
...
\begin{claim}\label{claim:sl3a}
  ...
  is triply exponentially bounded.
    \mei{is "mapping set" a typo here?}
\end{claim}
...
Then by \Cref{claim:sl4} applied to $S= (\stepp + \circ \ X_{q,r})$,
the $D$-saturated set 
