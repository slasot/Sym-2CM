...
some base-period representation of $X$ can be computed 
...
As the bound $m$ on the number of iterations does not depend
on the input set $S$ when computing an iteration 
$S\mapsto S\cup f(S)$,
in the same way as above
we obtain the same 4-exponential bound on the norm of every
next iterate $X_{i+1}=X_i \cup f(X_i)$.
