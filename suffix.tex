...
After this operation, the length of the one-off paths becomes bounded by
$e' := 2e (C_0 + 1)$.
...
%
\begin{proof}
Suppose that the claim doesn't hold
...
of sum-increasing cycles of increasing steepness, i.e. let $c_{k_1}$
...
$t_{i+1}$, let $(x_{i+1}, y_{i+1})$ be the effect of the cycle $c_{i+1}$.
...
cycles that are either horizontally positive, or horizontally negative. 
...
is the steepness of the steepest sum-increasing 
