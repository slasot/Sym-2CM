...
\caption{
  ...
  with three candidates for a horizontally-negative cycle $c_j$, illustrated
  in terms of their combined effect
  (when scaled such that said effect lands on the vertical axis).
...
steeper than $c_2$, or sum-increasing, with the latter option
...
The cycles $c_i$ and $c_j$ we will show to exist will thus necessarily be major,
but we do not make use of this fact.
