...
\end{tikzpicture}
\caption{
    \figleft An illustration of how the possible runs get split into
    ...
    by one of these two cases. On the other hand,
    Case 3 is the \emph{fallback}: it handles runs where
    all sum-increasing cycles fall in the area labeled ``Case 3'' (blue).
