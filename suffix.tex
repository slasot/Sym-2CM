...
\end{tikzpicture}
\caption{
    An illustration of how the possible runs get split into
...
We classify these into three cases (\Cref{fig:cases}).
...
\caption{
  ...
  \textsf{\textbf{Left:}} An illustration of the properties of steepness.
  ...
  \textsf{\textbf{Right:}} A sum-increasing cycle $c_i$,
