...
we include to $T'$ the following transitions:
\[ \begin{split}
    q&(3a + 2, && 3b + 2, && 0)
...
As the vector contains only one zero, executing any cyclic rotation will
...
can make them zero, as only remainders 2 and 0 are
...
has remainder $1 \bmod 3$, therefore the sole negative number $-2$ cannot
