...
\]
where the lengths of each transition $t_i$ and cycle $c_j$ are at most $e$,
...
by inlining any minor cycles $c_i$ into their neighbouring one-off paths $t_{i-1}$ and $t_i$,
...
of all the one-off
transitions (and minor cycles) which occurred up to $c_i$ and let $(X_i, Y_i)$ be the
...
\[
    a'
    \, \leq \, a \,+\, S_\ell (1 + \varphi_\mathrm{max})
    \, \leq \, a \,+\, C_1 (1 + e\norm\V)
\]
