...
Composition of two semilinear relations, very much like intersection,
increases the norms of bases and periods at most polynomially.
This allows us, in combination with \Cref{claim:sl2}, to conclude:

\begin{claim} \label{claim:sl3}
  The relation $\stepp - \circ \ {\stepp 0}^*$ is effectively semilinear,
  and the norms of bases and periods of its semilinear description
  are bounded triply-exponentially in $n$.
\end{claim}
