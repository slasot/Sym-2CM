...
\item all $\xupdinstr$ transitions $(q,\updinstr{\vr w},q')$ are 
\emph{single-counter}, that is $\vr w$  is nonzero on at most one coordinate.
\end{itemize}
% 
\para{Symmetric zero-tests}

For simplicity, let's focus on 2-\cm{s} first.
...
The above considerations generalize 
to $G$-\cm{s}, for 
...
namely the model of $d$-\cm{s}, $d\geq 2$,
is simulated by (and equivalent to) 1-\vass,
