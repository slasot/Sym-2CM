...
as the lower bound we only known  
...
Fornally, we will consider a segment as a run in the
...
In consequecnce, its further Presburger-definable restrictions 
